...
class Cosmos(Tokenizer):
    ...
    def __init__(
        self,
        model_name: str = "Cosmos-0.1-Tokenizer-DI8x8",
        ...
        **kwargs,
        ...
        super().__init__(model_name=model_name, checkpoint_dir=checkpoint_dir, device=device, dtype=dtype, **kwargs)
    ...
    def preprocess(self, image: Image.Image) -> torch.Tensor:
        ...
        # Convert to tensor
        input_tensor = numpy2tensor(batched_input_image, dtype=self.model._dtype, device=self.model._device)
