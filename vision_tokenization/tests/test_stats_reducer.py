...
from vision_tokenization.pipelines.distributed import stats_reducer
...
def test_maybe_write_stats_summary_waits_for_all_ranks(tmp_path):
    ...
    _append_stats(
        stats_path,
        {"rank": 0, "samples_processed": 10, "tokens_generated": 100, "elapsed_time": 5.0},
    )
...
def test_recompute_stats_summary_uses_latest_entry_per_rank(tmp_path):
    ...
    _append_stats(
        stats_path,
        {"rank": 1, "samples_processed": 7, "tokens_generated": 70, "elapsed_time": 4.0},
    )
    _append_stats(
        stats_path,
        {"rank": 0, "samples_processed": 12, "tokens_generated": 120, "elapsed_time": 6.0},
    )
