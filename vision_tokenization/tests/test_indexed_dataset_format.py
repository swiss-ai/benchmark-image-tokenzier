...
class TestIndexedDatasetFormat:
    ...
    def test_document_indices(self):
        ...
        assert np.array_equal(data["doc_indices"], expected_doc_indices), \
    ...
    def test_binary_file_content(self):
        ...
        assert np.array_equal(saved_tokens, tokens), \
            f"Token mismatch: expected {tokens}, got {saved_tokens.tolist()}"
    ...
    def test_multimodal_tokenizer_offset(self):
        ...
        assert np.array_equal(saved_tokens, expected_tokens), \
    ...
    def test_file_size_calculation(self):
        ...
        assert actual_idx_size == expected_idx_size, \
    ...
    def test_sequence_extraction(self):
        ...
        for i, expected_seq in enumerate(sequences):
            ...
            assert np.array_equal(extracted, expected_seq), \
