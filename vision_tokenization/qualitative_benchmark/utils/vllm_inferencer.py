...
class VLLMInferencer:
    ...
    def __init__(self, model_path: str,
        ...
        if tokenizer_path is not None:
            ...
            logger.warning("No tokenizer given, vllm will initialize from model tokenizer which might be unintended or fail!")
    ...
    def run_inference(self, prompt: Union[str, List[int]],
        ...
        if isinstance(prompt, str):
            if self.txt_tokenizer is not None:
                ...
                logger.warning("Specific Tokenizer(VLLMInferencer.txt_tokenizer) not given, vllm will try to use default model tokenizer which might be unintended or fail!")
