...
from vision_tokenization.discrete.dpo_pairs import assemble_from_tokenized, tokenized_from_row
...
def build_dpo_binidx(store_dir: str, *, system: str = "empty") -> dict:
    store = Path(store_dir)
    _ = json_load(store / "manifest.json")

    out = {"system": system, "splits": {}}
    for split in SPLITS:
